...
export const messages = {
  en: {
    ...
    hunger: {
      title: 'Hunger Level',
      description: 'Current hunger status for both partners.',
      level: 'Hunger Level',
      live: 'Live',
    ...
    battery: {
      title: 'Partner-Akku',
      description: 'Current energy level for both partners.',
      level: 'Akku',
      live: 'Live',
      saveFailed: 'The partner battery level could not be saved.',
    },
    qr: {
  ...
  de: {
    ...
    hunger: {
      title: 'Hunger Level',
      description: 'Aktueller Hunger-Status für beide Partner.',
      level: 'Hunger Level',
      live: 'Live',
    ...
    battery: {
      title: 'Partner-Akku',
      description: 'Aktueller Energie-Status für beide Partner.',
      level: 'Akku',
      live: 'Live',
      saveFailed: 'Der Partner-Akku konnte nicht gespeichert werden.',
    },
    theme: {
      settings: 'Theme Settings',
      primary: 'Primär',
